...
# spreadsheet software (like Microsoft Excel and Google Sheets) is exported into a 
# portable format. A spreadsheet that looks like the following
#
# <typical sheet presented>
#
...
# labels of the data that's present in the rest of the file. The rest of the rows
# of the file are the same as the rows in the spreadsheet software, just instead 
# of being separated into different cells they're separated by... well I suppose
# it's fair to say they're separated by commas. 
#
# Tasks:
# 1. CSV files are just plain text files!
# 	 
#    Open logger.csv using our standard with syntax, saving the file object
#		 in the temporary variable log_csv_file.
#
# 2. Print out the contents of logger.csv by calling .read() on the file. Notice
