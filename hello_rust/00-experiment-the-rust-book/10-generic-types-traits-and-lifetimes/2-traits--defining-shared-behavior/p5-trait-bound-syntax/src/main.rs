...
// two parameters that implement Summary. Doing so with the impl Trait looks like this:
...
// The generic type T specified as the type of the item1 and item2 paramters constrains the
// function such that the concrete type of the value passed as an arbument for item1 and item2 must
// be the same.
