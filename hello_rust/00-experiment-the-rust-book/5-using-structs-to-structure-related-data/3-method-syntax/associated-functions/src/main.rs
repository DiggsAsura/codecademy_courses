 ...
 *
 * To call this associated function, we use the :: syntax with the stuct name; let sq =
 * Rectangle::square(3); is an example. This function is namespaced by the struct: the :: syntax is
 * used for both associated functions and namedpaces created by modules. We'll discuss modules in
 * Chapter 7. 
*/
fn main() {
