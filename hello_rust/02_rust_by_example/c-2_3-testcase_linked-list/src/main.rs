...
enum List {
    ...
    Nil,
            ...
            // omg, whats going on here lol

// Methods can be attached to an enmum
impl List {
    ...
    fn len(&self) -> u32 {
        ...
        // preferred over a match on a reference '&T' after Rust 2018 you can use self here and
        // tail (with no ref) below as well, rust will infer &s and ref tail.
