 ...
 * =============
 *
 * A bound can also be expressed using where clause immediately before the opening {, rather than
 ...
 *
 *  - When specifying genric types and bounds separately is clearer: 
 */
