 ...
 * The drawback is that the underlying error type is only known at runtime and 
 * not statically determined.
 *
 * The stdlib helps in boxing our errors by having Box implement conversoin from 
