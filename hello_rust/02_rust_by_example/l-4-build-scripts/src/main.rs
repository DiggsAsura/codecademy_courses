 ...
 * before cargo will successfully compile, things like code generation, or some native code that
 * needs to be compiled. To solve this problem we have build scripts that Cargo can run.
 *
 ...
 * compiling anything else in the package. Hence it can be used to fullfill pre-requisites of your
 * crate. 
 *
 ...
 * target/debug/build/<pkg>/output. Further, lines prefixed with cargo: will be interpreted by
 * Cargo directly and hence can be used to define parameters for the package's compilation.
 *
