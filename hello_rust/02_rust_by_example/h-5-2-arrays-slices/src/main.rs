...
fn main() {
    ...
    match array {
        ...
        // You can also bind some and ignor the rest
        [-1, second, ..] => println!("array[0] = -1, array[1] = {} and all the other ones where ignored", second),

        // The code below would not compile
        // [-1, second] => ...

        // Or store them in another array/slice (the type depends on that of the value that is
