 ...
 * owner. This also prevents resources from being freed more than once. Note that not all variables
 ...
 *
 * After moving resources, the previous owner can no longer be used. This avoids creating dangling
 * pointers. */
...
fn main() {
    ...
    println!("x is {}, and y is {}", x, y);   // this explains why my test got this output too!
