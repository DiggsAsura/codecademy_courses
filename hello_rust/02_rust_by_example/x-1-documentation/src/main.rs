 ...
 * these are the comments that get compiled into documentation. They are denoted by a ///, and
 * support Markdown. */

#![crate_name = "x_1_documentation"]
 ...
 *
 * // Example from the future-rs library
 * #[doc(hidden)]
 * pub use self::async_await::*;
 *
 *
 *
 * For documentation, rustdoc is widely used by the community. It's what is used to generate the
 * std library docs. 
