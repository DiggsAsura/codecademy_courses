...
fn main() {
    // In general, the {} will automatically replaced with any arguments. These will be
    // stringified.
    println!("{} days", 31);
    ...
    println!("Base 16 (hexadecimal) repr: {:x}", 69420); // lower case
    println!("Base 16 (hexadecimal) repr: {:X}", 69420); // upper case 
    ...
    // You can use named argumnets in the format specifier by appending a '$'
    ...
    // estimation for pi. 
    // Hint: you can use the documentation: https://doc.rust-lang.org/std/fmt/
    let pi = 3.141592;
    println!("Pi is roughly {:.3}", pi);

}

// std::fmt contains many traits which govern the display of text. The base of two important
// ones are listed below:
//
// fmg::Debug : Uses the {:?} marker. Format text for debugging purposes. 
// fmt::Display : Uses the {} marker. Format text in a more elegant, user friendly fashion.
//
// Here, we used fmt::Display because the std library provides implementations for these types. To
