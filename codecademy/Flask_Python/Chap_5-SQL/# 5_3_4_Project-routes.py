...
#A form for inputting new song via Dashboard
...
@app.route('/add_item/<int:user_id>/<int:song_id>/<ing:playlist_id>')
...
@app.route('/remove/<int:user_id>/<int:item_id>')
