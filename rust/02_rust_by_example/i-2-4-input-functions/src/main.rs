...
// Define a function which makes a generic 'F' argument
...
/* As an additional note, the Fn, FnMut, and FnOnce traits dictate how a closure captures variables
 * from the enclosing scope. */

        // Understand but not really understand. I feel i get a better understanding of F, at
        // least. 
