...
impl Iterator for Fibonacci {
    ...
    //  * Otherwise, the next value is warpped in 'Some' and returned.
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        // Since there's no endpoint to a Fibonacci sequence, the 'Iterator' will
        // never return 'None', and 'Some' is always returned. 
        Some(current)
    }
}
