...
// ====================================
//
// We saw in Listing 17-11 that we want to be able to call a method named add_text and pass it a
// &str that is then added as the text content of the blog post. We implement this as a method,
// rather than exposing the content field as pub, so that later we can implement a method that will
...
// so it's not part of the sate pattern. The add_text method doesnt't interact with the state field
// at all, but its is part of the behavior we want to support.
