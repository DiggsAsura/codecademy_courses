...
// each item to a running total and returns the total when iteration is complete. Listing 13-13 has
...
// 13-13: Calling the sum method to get the total of all items in the iterator
