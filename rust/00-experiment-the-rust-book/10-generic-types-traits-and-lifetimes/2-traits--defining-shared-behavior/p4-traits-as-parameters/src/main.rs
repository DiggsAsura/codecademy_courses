...
// notify, we can call any methods on item that come frmo the Summary trait, such as summarize. We
// can call notify and pass in any instance of NewsArticle or Tweet. Code that calls the cuntion
// with any type other type, such as a String or an i32, won't compile because those types don't
// implement Summary.
