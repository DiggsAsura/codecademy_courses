...
// the version of the search function with an explicit for loop or the version with ieterators.
//
...
// Rust'ds zero-cost abstractions, by which we mean using the abstraction imposes no additional
...
// to shift data in qlp-shift. We've declared the variables within this example but not given them
...
// able to apply make the resulting code extremly efficient. Now that you know this, you can use
// iterators and closures wihtout fear! They maake code seem like it's higher level but don't
