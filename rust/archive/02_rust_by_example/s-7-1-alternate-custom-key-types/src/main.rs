 ...
 *
 * You can easily implement Eq and Hash for a cutsom type with just one line: #[derive(PartialEq,
 * Eq, Hash)]
 *
 * The compiler will do the rest. I fyou want more control over the details, you can implement Eq
 * and/or Hash yourself. This guide will not cover the specifics of implementing Hash. 
 *
