 ...
 * pub modifier. Only the public itmes of a module can be accessed from outside the module scope.
 */
...
mod my_mod {
    ...
    pub mod nested {
        ...
        // Functions declare using 'pub(in path)' syntax are only visible within the given path.
    ...
    // pub(crate) makes functions visibile only within the current crate
    ...
    mod private_nested {
        ...
        // declared as visibile within a bigger scope. 
        #[allow(dead_code)]
...
fn main() {
    ...
    //my_mod::nested::public_function_in_my_mode();
    // TODO^ Uncomment to try
    //
