 ...
 * ===================
 *
 * How about when we want to reuse a specific Result type many times? Recall that Rust allows us to
 * create aliases. Conveniently, we can define one for the specific Result in question.
 *
 * At a module level, creating aliases can be particulary helpful. Errors found in a specific
...
// Here, the alias agian allows us to save some space.
