...
// One input reference with lifetime 'a which must life at least as long as the function.
...
// The above is invalid: 'a must live longer than the function. Here, 'String::from("foo") would
// create a 'String', followed by a reference. Then the data is dropped upon exiting the scope,
